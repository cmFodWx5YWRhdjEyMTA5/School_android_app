...
public class CameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    private OnPictureCaptureListener captureListener;
    ...
    public void onAttach(Context context) {
        ...
        captureListener = ((OnPictureCaptureListener) context);
    }
...
//                .commit();
        ...
        Bitmap bitmap = ImageUtility.decodeSampledBitmapFromByte(Objects.requireNonNull(getActivity()), data);
        ...
        if (captureListener!=null){
            ...
            captureListener.onPictureCapture(bitmap);
        }
        setSafeToTakePhoto(true);
        restartPreview();
    }
