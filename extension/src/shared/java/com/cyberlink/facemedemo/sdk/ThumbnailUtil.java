...
public class ThumbnailUtil {
    ...
    public static Rect enlargeThumbnail(Rect src, Size image_size, float enlargeRatio, boolean isShift) {
    ...
    public static Rect enlargeThumbnail(Rect src, Size imageSize, int leftSpace, int topSpace, int rightSpace, int bottomSpace, boolean isShift) {
